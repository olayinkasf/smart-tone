...
public class RingtoneTelephonyService extends Service {
    ...
    private static final String NOTIF_CANCELED = "telephony.request.notif.canceled";
    ...
    public int handleIntent(Intent intent) {
        ...
        if (action!= null && action.equals(NOTIF_CANCELED)) {
            if (!PermissionUtils.hasSelfPermission(this, Manifest.permission.READ_PHONE_STATE)) {
                ...
                ShuffleStub.Ringtone.start(this);
                mNotifyMgr.notify(
        ...
        if (!PermissionUtils.hasSelfPermission(this, Manifest.permission.READ_PHONE_STATE)) {
            ...
            Intent cancelIntent = new Intent(this, RingtoneTelephonyService.class);
